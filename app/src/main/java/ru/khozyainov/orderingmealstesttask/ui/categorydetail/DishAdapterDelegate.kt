...
class DishAdapterDelegate(
    ...
    override fun onCreateViewHolder(parent: ViewGroup): DishHolder = DishHolder(
    ...
    override fun onBindViewHolder(
        item: DishUi, holder: DishHolder, payloads: MutableList<Any>
    ) {
        holder.bind(dish = item)
    }

    class DishHolder(
        private val binding: ItemDishBinding, onItemClicked: (dish: DishUi) -> Unit
